<footer class="footer py-4  ">
        ...
        <div class="row align-items-center justify-content-lg-between">
          ...
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">Ahmad Nidhom</a>
              </li>
              <li class="nav-item">
  ...
  <!--   Core JS Files   -->
  <script src="{{ asset('mod') }}/js/core/pro.min.js"></script>
  ...
  <script src="{{ asset('mod') }}/js/plugins/choices.min.js"></script>
  <script src="{{ asset('mod') }}/js/plugins/quil.min.js"></script>
  <script src="{{ asset('mod') }}/js/plugins/flatpickr.min.js"></script>
  <script src="{{ asset('mod') }}/js/plugins/dropzone.min.js"></script>
  <script src="{{ asset('mod') }}/js/plugins/multistep-form.js"></script>
  <!-- Kanban scripts -->
  ...
  <script src="{{ asset('mod') }}/js/material-dashboard.min.js?v=3.0.5"></script>
</body>
