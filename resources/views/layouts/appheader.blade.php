...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('mod') }}/img/apple-icon.png">
    <link rel="icon" type="image/png" href="{{ asset('mod') }}/img/favicon.png">
    <title>
        Darma Digital Solution
    </title>
    ...
    <!-- Nucleo Icons -->
    <link href="{{ asset('mod') }}/css/nucleo-icons.css" rel="stylesheet" />
    <link href="{{ asset('mod') }}/css/nucleo-svg.css" rel="stylesheet" />
    <link href="{{ asset('mod') }}/css/pro.css" rel="stylesheet" />
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('mod') }}/css/material-dashboard.min.css?v=3.0.1" rel="stylesheet" />
