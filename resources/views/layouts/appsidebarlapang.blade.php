<aside
    ...
    <div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mb-2 mt-0">
                <a class="nav-link text-white" href="/lapang">
            ...
            <li class="nav-item mb-2 mt-0">
                <a class="nav-link text-white collapsed" data-bs-toggle="collapse" aria-expanded="false"
                    href="#profileExample">
                    <span class="sidenav-mini-icon material-icons"> book </span>
                    <span class="sidenav-normal  ms-2  ps-1"> Add Jurnal <b class="caret"></b></span>
                </a>
                    ...
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a class="nav-link text-white " href="../../../pages/pages/profile/overview.html">
                                ...
                                <span class="sidenav-normal  ms-2  ps-1"> nama kelompok </span>
                            </a>
                        </li>    
                        <li class="nav-item">
                            <a class="nav-link text-white " href="../../../pages/pages/profile/overview.html">
            ...
            <li class="nav-item mb-2 mt-0">
                <a class="nav-link text-white" href="/reportmahasiswa">
                    <span class="sidenav-mini-icon material-icons"> analytics </span>
                    <span class="sidenav-normal  ms-3  ps-1"> Report Mahasiswa </span>
                </a>
            </li>
            <li class="nav-item mb-2 mt-0">
